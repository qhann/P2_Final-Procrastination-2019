...
class EndScreen extends Component {
  ...
  render() {
    ...
    if (sleepTime < 2 * 60 * 3) {
      tiredness = "dead"
      mentorText += `Du hast durchschnittlich ${~~(sleepTime / 60 / 3)} Stunden geschlafen. 8 Stunden pro Nacht sind empfehlenswert. Durch den extremen Schlafmangel hast du Depressionen entwickelt und dein Risiko für Herzinfarkte hat sich durch Arteriosklerose extrem erhöht. Du hattest eine Herzattacke und bist gestorben.`
    } else if (sleepTime < 4 * 60 * 3) {
      tiredness = "sickest"
      mentorText += `8 Stunden pro Nacht sind empfehlenswert. Du hast durchschnittlich ${~~(sleepTime / 60 / 3)} Stunden geschlafen. Durch den großen Schlafmangel hast du gravierende Krankheiten, wie Depressionen, Fettleibigkeit, Diabetes, ein erhöhtes Alzheimerrisiko und Herzerkrankungen entwickelt, welche deine Lebensqualität immens einschränken. Regelmäßige Krankenhausaufenthalte und Medikamente gehören nun zu deinem Alltag.`
    } else if (sleepTime < 6 * 60 * 3) {
      tiredness = "tiredest"
      mentorText += `8 Stunden pro Nacht sind empfehlenswert. Du hast im Schnitt ${~~(sleepTime / 60 / 3)} Stunden geschlafen, dadurch wirst du ständig von Paranoia und hohem Stressempfinden, mit gelegentlichen Halluzinationen geplagt. Außerdem ist dein Risiko für Herzinfarkte um 100% gestiegen. Du bewältigst deinen Alltag unter starkem Konzentrationsmangel, erhöhter Reizbarkeit und vermindertem Reaktionsvermögen.`
    } else if (sleepTime < 8 * 60 * 3) {
      tiredness = "tired"
      mentorText += `8 Stunden pro Nacht sind empfehlenswert. Du hast im Schnitt ${~~(sleepTime / 60 / 3)} Stunden geschlafen, wodurch sich dein Konzentrations- und Reaktionsvermögen vermindert und deine Reizbarkeit erhöht hat. Du bewältigst deinen Alltag unter leichter, aber konstanter, Einschränkung deiner Lebensqualität.`
    } else if (sleepTime > 8 * 60 + 3) {
      tiredness = "rested"
      mentorText += `8 Stunden pro Nacht sind empfehlenswert. Du hast im Schnitt ${~~(sleepTime / 60 / 3)} Stunden geschlafen, somit hast du alles richtig gemacht und bist gesund! Herzlichen Glückwunsch, du kannst dich glücklich schätzen, schwerwiegende Krankheiten, wie Herzerkrankungen, umgangen zu haben!`
    }
      ...
      <div className={"end-screen"}>
        ...
        <div className={"award-wrapper"}>
          ...
          <div className={"trophy-wrapper"}>
            {awardsCount == 0 ? <img className={"trophy trophy-trash"} src={trophy0} alt="" /> : null}
